...
//页码 height
#define PageShowHeight          30
//页码、remark等通用margin
#define PageShowMargin          15
//文本Scroll 高度
...
- (UIButton *)saveBtn {
    if (!_saveBtn) {
        ...
        CGRect frame = CGRectZero;
        frame.origin.x = CGRectGetWidth(self.bounds) - PageShowWidth - PageShowMargin;
        frame.origin.y = CGRectGetHeight(self.bounds) - PageShowHeight - PageShowMargin;
        frame.size = CGSizeMake(PageShowWidth, PageShowHeight);
        _saveBtn.frame = frame;
        [_saveBtn setTitleColor:[UIColor whiteColor]
                       forState:UIControlStateNormal];
        [_saveBtn setTitle:@"保存" forState:UIControlStateNormal];
        _saveBtn.titleLabel.font = SubTitleFont;
        _saveBtn.layer.borderColor = WhiteColor.CGColor;
...
- (UILabel *)pageLabel{
    if (!_pageLabel) {
        ...
        CGRect frame = CGRectZero;
        frame.origin.x = PageShowMargin;
        frame.origin.y = CGRectGetHeight(self.bounds) - PageShowHeight - PageShowMargin;
        frame.size = CGSizeMake(PageShowWidth, PageShowHeight);
        _pageLabel.frame = frame;
        _pageLabel.font = TitleFont;
        _pageLabel.textColor = WhiteColor;
